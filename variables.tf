...
variable "prometheus_user_values_override" {
  type        = string
  default     = ""
  description = "User provided values to override the prometheus helm chart defaults and those generated by Terraform using the templates."
}

variable "opencost_user_values_override" {
  type        = string
  default     = ""
  description = "User provided values to override the Opencost helm chart defaults and those generated by Terraform using the templates."
}
